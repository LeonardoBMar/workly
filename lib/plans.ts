export const PLANS = {
    ...
    BUSINESS: {
        id: "business",
        name: "Business",
        priceId: process.env.STRIPE_BUSINESS_PRICE_ID || "price_placeholder_business",
        price: 59.90,
        quota: Infinity,
    },
} as const;
...
export function getCurrentPlan(stripePriceId: string | null | undefined, subscriptionStatus: string | null | undefined) {
