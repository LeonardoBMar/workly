          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <button className="flex items-center text-sm font-semibold text-indigo-600 transition-all group-hover:gap-2">
                  Saiba mais{' '}
                  <ArrowRight className="ml-1 h-4 w-4 opacity-0 transition-all group-hover:opacity-100" />
                </button>
              </div>
            );
          })}
