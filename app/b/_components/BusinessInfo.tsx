      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            ...
            <p className="text-sm text-neutral-400">São Paulo, SP</p>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="flex items-center gap-2 text-sm text-neutral-600 transition-colors hover:text-indigo-600"
              >
                (11) 99999-9999
              </a>
              <a
                ...
                target="_blank"
                className="flex items-center gap-2 rounded-xl bg-emerald-50 px-4 py-2.5 text-sm font-medium text-emerald-700 transition-colors hover:bg-emerald-100"
              >
                <svg
                  width="16"
                  height="16"
